...
- **GOAL-8.4** [P1]: The `DataLoader` trait supports async loading (`async fn`) for consumers that need to fetch examples from network sources or databases.
...
- **rand** — Minibatch sampling, Pareto front selection randomness
